...
class AlignProjector(nn.Module):
    ...
    def __init__(
        ...
        # Set default width_ratios, linear distribution
        ...
        # Reverse ratios if shallow layers use more parameters
    ...
    def forward(self, LLM_emb, target_emb, align_mask, layer_index: int = -1):
        """
        Args:
            LLM_emb: LLM embedding
            target_emb: Target embedding (VGGT)
            align_mask: Mask for valid alignment positions
